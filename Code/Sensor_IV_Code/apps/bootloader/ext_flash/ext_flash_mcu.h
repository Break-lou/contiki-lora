...
//sim3l144没有该端口
#define EXT_FLASH_PORT_POWER_OFF()	SI32_PBSTD_A_set_pins_push_pull_output(SI32_PBSTD_0, 0X0200);\
		SI32_PBSTD_A_write_pins_low(SI32_PBSTD_0, 0X0200);\
		SI32_PBSTD_A_set_pins_push_pull_output(SI32_PBSTD_1, 0X0003);\
		SI32_PBSTD_A_write_pins_low(SI32_PBSTD_1, 0X0003)
